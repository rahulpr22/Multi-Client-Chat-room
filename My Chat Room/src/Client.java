...
public class Client  {
	...
	public static void main(String[] args) {
		...
		System.out.println("3. Type 'VIEWGROUP' without quotes to see list of active clients");
		...
		while(true) {
			...
			else if(msg.equalsIgnoreCase("VIEWGROUP")) {
				client.sendMessage(new ChatMessage(ChatMessage.VIEWGROUP, ""));				
			}
			else {
	...
	class ListenFromServer extends Thread {
		...
		public void run() {
			while(true) {
				try {
                    String readString=(String) sInput.readObject();
                    ...
                    // TODO Auto-generated catch block
                    System.out.println("*** Server has closed Connection"+ e +" *** ");
                    break;
                }
			}
		}
